...
def upload_object(filename, bucket_name, key_name):
 ...
 #   try:
        conn = boto.s3.connect_to_region('us-east-2',
                                         aws_access_key_id='AKIAJZQXLYSVFPTU3J2Q',
                                         aws_secret_access_key='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',
...
#How to call
#rw_s3_bucket.download_object('<full file path>','dejaview','test01.jpg')

def download_object(filename, bucket_name, key_name):
